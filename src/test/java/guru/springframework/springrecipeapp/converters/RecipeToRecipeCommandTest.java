...
class RecipeToRecipeCommandTest {
    ...
    void setUp() {
        ...
        unitOfMeasureCommand.convert(unitOfMeasure);
        converter = new RecipeToRecipeCommand(new NotesToNotesCommand(), new CategoryToCategoryCommand(), new IngredientToIngredientCommand(unitOfMeasureCommand));
    }
